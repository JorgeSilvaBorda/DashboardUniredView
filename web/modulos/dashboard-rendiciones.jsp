...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Proceso Rendiciones</h1>
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body cursor-pointer" onclick="getDetalleRendiciones('ejecucion')">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-secondary shadow h-100 py-2">
                <div class="card-body cursor-pointer" onclick="getDetalleRendiciones('generado')">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">
                                Generadas</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="generado"></div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-secondary shadow h-100 py-2">
                <div class="card-body cursor-pointer" onclick="getDetalleRendiciones('transmitido')">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">
                                Transmitidas</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="transmitido"></div>
                        </div>
                        <div class="col-auto">
